...
<div class="grid grid-cols-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                                        <a href="/stdc-program-onboarding-system/admin/attendees.php?program_id=<?php echo $prog['id']; ?>" class="btn btn-sm btn-outline">View Attendees</a>
                                        <a href="/stdc-program-onboarding-system/admin/edit_program.php?id=<?php echo $prog['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                        
                                        <?php if (isDeveloper()): ?>
                                            <form action="/stdc-program-onboarding-system/admin/program_actions.php" method="POST" style="margin: 0; display: contents;">
    ...
    <div class="mt-4 mb-4" style="background-color: var(--bg-light); padding: 1.5rem; border-radius: 8px; border: 1px solid var(--border-color);">
        ...
        <div class="template-gallery" style="display: flex; gap: 1.5rem; overflow-x: auto; padding-bottom: 0.5rem;">
            <!-- Blank Template -->
            <a href="/stdc-program-onboarding-system/admin/create_program.php" class="template-card-link" style="text-decoration: none; color: inherit; width: 140px; flex-shrink: 0;">
            ...
            <div style="position: relative; width: 140px; flex-shrink: 0;">
                <a href="/stdc-program-onboarding-system/admin/create_program.php?template_id=<?php echo $tpl['id']; ?>" class="template-card-link" style="text-decoration: none; color: inherit; display: block;">
                ...
                <form action="/stdc-program-onboarding-system/admin/programs.php" method="POST" style="position: absolute; top: 8px; right: 8px; margin: 0; z-index: 10;">
