...
<div class="grid grid-cols-3">
    ...
    <div class="stat-card">
        <a href="/stdc-program-onboarding-system/admin/registrations.php"><span class="stat-title">Pending Registrations</span></a>
...
<script>
    ...
    async function loadSession(id, element) {
        ...
        try {
            const res = await fetch(`/stdc-program-onboarding-system/admin/api/get_chat.php?session_id=${id}`);
    ...
    async function deleteSession(event, id) {
        ...
        try {
            const res = await fetch('/stdc-program-onboarding-system/admin/api/delete_chat.php', {
                method: 'POST',
    ...
    function editSessionTitle(event, sessionId, spanElement) {
        ...
        async function saveTitle() {
            ...
            if (newTitle !== oldTitle) {
                try {
                    await fetch('/stdc-program-onboarding-system/admin/api/rename_chat.php', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
    ...
    async function submitAiPrompt() {
        ...
        try {
            const res = await fetch('/stdc-program-onboarding-system/admin/ai_query.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async function confirmDeleteMessage() {
        ...
        if (confirm("Delete this message?")) {
            try {
                const res = await fetch('/stdc-program-onboarding-system/admin/api/delete_message.php', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
