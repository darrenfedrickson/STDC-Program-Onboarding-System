...
<div class="mb-4">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end;">
        ...
        <div style="display: flex; gap: 0.5rem; align-items: center;">
            <a href="/iDaftar@STDC/admin/program_stats.php?program_id=<?php echo $program_id; ?>" class="btn btn-sm btn-outline" style="font-size: 0.75rem; padding: 0.25rem 0.75rem; border-color: var(--border-color); color: var(--text-color);">
            ...
            <a href="/iDaftar@STDC/admin/export_attendees.php?program_id=<?php echo $program_id; ?>" class="btn btn-sm btn-outline" style="font-size: 0.75rem; padding: 0.25rem 0.75rem; border-color: var(--border-color); color: var(--text-color);">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; flex-direction: column; gap: 0.25rem;">
                                    <form action="/iDaftar@STDC/admin/attendees.php?program_id=<?php echo $program_id; ?>" method="POST" style="display: flex; gap: 0.25rem;">
                                    ...
                                    <a href="/iDaftar@STDC/admin/attendee_details.php?id=<?php echo $reg['id']; ?>" class="btn btn-sm btn-outline" style="text-align: center; padding: 0.15rem; font-size: 0.75rem;">View Details</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
