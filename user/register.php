...
<div class="mb-4 text-center">
    <a href="/iDaftar@STDC/user/index.php" class="btn btn-sm btn-outline" style="background: white;">&larr; Back to Dashboard</a>
</div>
...
<div class="g-form-container">
    ...
    <?php if (!empty($program['poster_image'])): ?>
        <div class="g-form-card" style="padding: 0; overflow: hidden;">
            <img src="/iDaftar@STDC/<?php echo htmlspecialchars($program['poster_image']); ?>" alt="Program Poster" style="width: 100%; display: block;">
        </div>
    <?php endif; ?>
    
    <form action="/iDaftar@STDC/user/process_apply.php" method="POST" enctype="multipart/form-data">
