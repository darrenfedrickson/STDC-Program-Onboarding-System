...
<div class="auth-container">
    <div class="card auth-card">
        ...
        <form action="/stdc-program-onboarding-system/auth/login.php" method="POST">
        ...
        <p class="text-center mt-4">
            Don't have an account? <a href="/stdc-program-onboarding-system/auth/register.php">Register here</a>
        </p>
    </div>
</div>
