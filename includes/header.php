        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                function isActive($path, $currentPath) {
                    ...
                    if ($path === BASE_URL . '/admin/programs.php') {
                        if (strpos($currentPath, BASE_URL . '/admin/create_program.php') === 0 ||
                            strpos($currentPath, BASE_URL . '/admin/edit_program.php') === 0 ||
                            strpos($currentPath, BASE_URL . '/admin/attendees.php') === 0 ||
                            strpos($currentPath, BASE_URL . '/admin/attendee_details.php') === 0) {
                            return 'class="active"';
                        }
                    }
                    return '';
                ...
                ?>
                <?php if (isAdmin()): ?>
                    <li><a href="<?php echo BASE_URL; ?>/admin/index.php" <?php echo isActive(BASE_URL . '/admin/index.php', $currentPath); ?>>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                        <span class="nav-text">Dashboard</span>
                    </a></li>
                    <li><a href="<?php echo BASE_URL; ?>/admin/programs.php" <?php echo isActive(BASE_URL . '/admin/programs.php', $currentPath); ?>>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        <span class="nav-text">Manage Programs</span>
                    </a></li>
                    <li><a href="<?php echo BASE_URL; ?>/admin/users.php" <?php echo isActive(BASE_URL . '/admin/users.php', $currentPath); ?>>
                ...
                <?php endif; ?>
                <li><a href="<?php echo BASE_URL; ?>/auth/logout.php" style="color: var(--danger);">
